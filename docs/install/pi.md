...
# Installing ledger-memory on Pi
...
- `.pi/extensions/ledger-memory.ts`, the Pi extension module that registers the plugin's skills directory and injects bootstrap context

## Installing

```
pi install git:github.com/prime-radiant-inc/ledger-memory
```
