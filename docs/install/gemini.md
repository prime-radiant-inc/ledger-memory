...
# Installing ledger-memory on Gemini CLI

## What gets emitted

- `gemini-extension.json`
- `GEMINI.md`, importing the bootstrap skill via Gemini's `@`-import syntax
...
```
gemini extensions install https://github.com/prime-radiant-inc/ledger-memory
```
