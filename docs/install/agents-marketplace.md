...
# Installing ledger-memory on Factory Droid / Grok / Copilot (marketplace descriptor)
...
```
droid plugin marketplace add https://github.com/prime-radiant-inc/ledger-memory
droid plugin install ledger-memory@ledger-memory
```
...
```
copilot plugin marketplace add https://github.com/prime-radiant-inc/ledger-memory
copilot plugin install ledger-memory@ledger-memory-market
```

On Grok:

```
grok plugin install https://github.com/prime-radiant-inc/ledger-memory --trust
```
